                ...
                <x-ui.card>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select id="product" name="items[0][product_id]" class="mt-1 w-full rounded-xl border-slate-200">
                        ...
                        <div>
                            ...
                            <select id="variant" name="items[0][variant_id]" class="mt-1 w-full rounded-xl border-slate-200">
                        ...
                        <div>
                            ...
                            <select id="volume" name="items[0][volume_id]" class="mt-1 w-full rounded-xl border-slate-200">
                        ...
                        <div>
                            ...
                            <input type="number" id="quantity" name="items[0][quantity]" min="1"
