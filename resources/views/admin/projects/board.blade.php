<x-app-layout>
    <x-slot name="header">
        ...
        <p class="text-sm text-gray-500 mt-1">
            Pantau status project berdasarkan tahap pekerjaan.
        </p>
    </x-slot>
        ...
        <div class="bg-slate-50 rounded-2xl border border-slate-200 p-4">
            ...
            <div class="space-y-4">
                @forelse($todoProjects as $project)
                    @include('admin.projects.partials.project-card', ['project' => $project, 'color' => 'slate'])
                @empty
        ...
        <div class="bg-orange-50 rounded-2xl border border-orange-200 p-4">
            ...
            <div class="space-y-4">
                @forelse($inProgressProjects as $project)
                    @include('admin.projects.partials.project-card', ['project' => $project, 'color' => 'orange'])
                @empty
        ...
        <div class="bg-yellow-50 rounded-2xl border border-yellow-200 p-4">
            ...
            <div class="space-y-4">
                @forelse($needApprovalProjects as $project)
                    @include('admin.projects.partials.project-card', ['project' => $project, 'color' => 'yellow'])
                @empty
        ...
        <div class="bg-green-50 rounded-2xl border border-green-200 p-4">
            ...
            <div class="space-y-4">
                @forelse($doneProjects as $project)
                    @include('admin.projects.partials.project-card', ['project' => $project, 'color' => 'green'])
                @empty
